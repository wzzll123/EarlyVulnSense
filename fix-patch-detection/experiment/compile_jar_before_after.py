...
from release_jar_exp import parse_exp_json,ensure_directory_exists
from compile_jar_exp import do_exp_for_one
import os
import sys
...
if __name__ == '__main__':
    ...
    commiit2release_dict=parse_exp_json("experiment/compile_commit2release.json")
